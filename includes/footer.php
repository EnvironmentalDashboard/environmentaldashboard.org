...
<div class="row">
  <div class="col">
    <p class="text-muted text-center" style="margin-top: 30px">Oberlin College <?php echo date('Y') ?> | <a href="mailto:dashboard@oberlin.edu" style="color: #6c757d; text-decoration: underline;">dashboard@oberlin.edu</a>
    </p>
  </div>
</div>
