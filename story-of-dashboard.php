  ...
  <body>
    <div class="container">
     ...
     <!--  <h3 class="text-center">CampusEnergy2017 Student Video Contest: Oberlin College (Like our video!)</h3>
      <div class='embed-responsive embed-responsive-16by9'><iframe class="embed-responsive-item" src="https://www.youtube-nocookie.com/embed/1H49cDTKTX0?rel=0" frameborder="0"></iframe></div>
      <h3 class="text-center">Learn more about the Environmental Dashboard from members of the team!</h3>
      <div class='embed-responsive embed-responsive-16by9'><iframe class="embed-responsive-item" src="https://www.youtube-nocookie.com/embed/eNTC7dDEAsU?rel=0&showinfo=0" frameborder="0"></iframe></div> -->
      ...
      <div class="row text-center">
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="card h-100">
            ...
            <div class="card-footer">
              <a href="https://www.youtube.com/embed/YSXFKSvN75o" class="btn btn-primary">Link to Youtube</a>
            </div>
          </div>
        </div>
         ...
         <div class="col-lg-4 col-md-6 mb-4">
          <div class="card h-100">
            ...
            <div class="card-footer">
              <a href="https://www.youtube.com/embed/ZFVBPEpA4RA" class="btn btn-primary">Link to Youtube</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          ...
          <iframe width="100%" height="200" src="https://www.youtube.com/embed/2fCQ3qdJnh0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            ...
            <div class="card-footer">
              <a href="https://www.youtube.com/embed/2fCQ3qdJnh0" class="btn btn-primary">Link to Youtube</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          ...
          <div class="card-body">
            ...
            <div class="card-footer">
              <a href="https://www.youtube.com/embed/VEUDNRkChXs" class="btn btn-primary">Link to Youtube</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          ...
          <div class="card-body">
            ...
            <div class="card-footer">
              <a href="https://www.youtube.com/embed/3zge8P0GtPM" class="btn btn-primary">Link to Youtube</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          ...
          <div class="card-body">
            ...
            <div class="card-footer">
              <a href="https://www.youtube.com/embed/xW_HXfanP68" class="btn btn-primary">Link to Youtube</a>
            </div>
          </div>
        </div>
      </div>
